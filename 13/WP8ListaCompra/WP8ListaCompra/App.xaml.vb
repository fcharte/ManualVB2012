...
Partial Public Class App
   ...
   Private Sub Application_Deactivated(ByVal sender As Object, ByVal e As DeactivatedEventArgs)
      Dim archivo = IsolatedStorageFile.GetUserStoreForApplication.OpenFile("ListaCompra.xml", IO.FileMode.Create)
      Dim serializador = New XmlSerializer(GetType(ObservableCollection(Of ItemViewModel)))
      Dim writer = New StreamWriter(archivo)
      serializador.Serialize(writer, App.ViewModel.Items)
